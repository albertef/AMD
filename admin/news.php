                ...
                <div class="tab-pane fade in active" id="add">
                    ...
                    <?php
                        if(isset($_GET['news_id']) && isset($_GET['edit'])){
                            ...
                            $sql = "SELECT * FROM amd_news WHERE news_id = ". $news_id;
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <div class="form-group">
                                            <label for="inputPhone3" class="col-sm-2 control-label">News Source</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="" name="news_source" value="' . $row["news_source"] . '">
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <label for="inputPhone3" class="col-sm-2 control-label">News Source</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="" name="news_source">
                                </div>
                            </div>
                    ...
                    <?php
                        ...
                        if(isset($_POST['news-btn'])){
                            ...
                            $news_source = trim(mysqli_real_escape_string($conn, $_POST['news_source']));
                            ...
                            if(isset($_GET['news_id']) && isset($_GET['edit'])){
                                if($news_image != ""){
                                    $sql = "UPDATE amd_news SET news_title='$news_title', news_source='$news_source', news_desc='$news_desc', news_date='$news_date', news_category='$news_category', news_image='$news_image' WHERE news_id=". $_GET['news_id'];
                                }
                                else {
                                    $sql = "UPDATE amd_news SET news_title='$news_title', news_source='$news_source', news_desc='$news_desc', news_date='$news_date', news_category='$news_category' WHERE news_id=". $_GET['news_id'];
                                }
                                if (mysqli_query($conn, $sql)) {
                                ...
                                $sql = "INSERT INTO amd_news (news_title, news_source, news_desc, news_date, news_category, news_image ) VALUES ('".$news_title."', '".$news_source."', '".$news_desc."', '".$news_date."', '".$news_category."', '".$news_image."')";
                                if (mysqli_query($conn, $sql)) {
