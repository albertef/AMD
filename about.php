<?php include ("includes/header.php"); ?>
    ...
    <div class="welcome-note">
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 no-padding">
            <div class="about-inner-left">
                <h4>WELCOME TO AMD</h4>
                <P>Design and media are one of the most powerful, inspiring, empowering and enlightening forces in our lives, whether we are aware of it or not. It influences what we think, the way we feel and the decisions we make, and when it is exceptionally well-done, good design is virtually invisible.</P>

                <P>A huge demand is expected from the market for professionally trained designers in the near future both in India and abroad, and under the present circumstances, only one-fifth of the potential is realized yet. It is here that the need for professionally trained individuals arises. Design and Media studies with its hybrid nature prepare designers with specialization in a particular domain while having varying degrees of knowledge and skills to address specific occupations and open up several career pathways.</P>
            </div>
        </div>
            ...
            <div class="about-inner-right welcome-inner-right">
                <p>
                    <ul>
                        ...
                        <li>Adobe certified professionals can display Adobe certification logos on their business cards, resumes, and websites to leverage the power of the Adobe brand.</li>
                        <li>Resumes with Adobe certifications get noticed and fast-tracked by hiring managers.</li>
                        <li>Any other certifications if any and the importance they hold.</li>
                    </ul>
                </p>
            </div>
        </div>
    ...
    <div class="ceo-message">
        ...
        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 no-padding ceo-right">
            <div class="about-inner-right ceo-inner-right">
                <p>
                    <img src="img/power-house/img1.jpg" class="img-responsive">
                    <div class="ceo-testimonials">
                        ...
                        <span>
                            At AMD, we believe that your time at the institution is the start of your career.
                        </span>
