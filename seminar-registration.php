...
<html lang="en">
<head>
    <title>AMD - Academy of Media and Design | Seminar Registration </title>
...
<?php
        ...
        if(isset($_POST['register-form']))
        {
          ...
          $phone=trim(mysqli_real_escape_string($conn, $_POST['phone']));
			...
			$sql = 'SELECT * FROM amd_register WHERE register_email = "'.$email.'"';
			...
			if (mysqli_num_rows($result) > 0) {
				echo '
					<div id="myModal" class="modal fade in" role="dialog">
						...
						<div class="modal-content">
							...
							<p>You have already registered for the seminar!</p>
							</div>
						</div>
				...
				$sql = "INSERT INTO amd_register (register_name, register_email, register_phone) VALUES ('".$name."', '".$email."', '".$phone."')";
				...
				$subject="AMD Seminar Registration";
				...
				if(mail($tomail, $subject, $message, $headers))
				{
					...
					<div id="myModal" class="modal fade in" role="dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
							<p>You have successfully registered for the seminar! A mail will be sent to your Email address shortly! Meanwhile, head over to the <a href="http://www.amd.edu.in">AMD website</a> and find out more about us. <br><br>
