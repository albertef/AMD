<?php include ("includes/header.php"); ?>
    ...
    <div class="inner-pages">
        ...
        <div class="about-courses">
            <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-offset-1 col-lg-10 no-padding admission-page">
                ...
                <div class="admission-page-links clearfix">
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 btn-container text-center">
                        <a class="btn" onclick="window.location.assign('courses.php');">CHECK OUT OUR COURSES</a>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 btn-container text-center hidden-xs hidden-sm">
                        <a class="btn" onclick="window.location.assign('contact.php');">CONTACT US DIRECTLY</a>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 btn-container text-center hidden-md hidden-lg">
                        <a class="btn" href="tel:+919656039944">CALL US DIRECTLY</a>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 btn-container text-center">
                        <a class="btn" onclick="window.location.assign('campus.php');">CHECK OUT OUR CAMPUS</a>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 btn-container text-center hide">
                        <a class="btn">CHECK OUT WHAT OTHERS <br> HAVE TO SAY ABOUT US</a>
                    </div>
                </div>
                ...
                <div class="admission-form">
                    ...
                    <div class="form-container text-center">
                        <form action="" method="post" id="admissionForm" onsubmit="return admissionValidation();">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 no-padding">
                                    <input type="text" class="form-control" name="course" placeholder="Course Interest" id="course">
                                    <span class="courseError"><i class="fa fa-exclamation" aria-hidden="true"></i> Please enter a valid course interest</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 no-padding">
                                    <input type="text" class="form-control" name="career" placeholder="Career Interest" id="career">
        ...
        if(isset($_POST['admission-form']))
        {
		  ...
		  $career=trim(mysqli_real_escape_string($conn, $_POST['career']));
			...
			if (mysqli_num_rows($result) > 0) {
				...
				$headers1 .= "From:AMDcampus@amd.edu.in";
    ...
    ?>
                ...
                <div class="more-details clearfix hide">
                    <h5 class="text-center">FOR MORE DETAILS WOULD YOU LIKE TO</h5>

                    
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 text-center">
                        <a class="btn" onclick="window.location.assign('admission-form.php');">GET DETAILS VIA EMAIL</a>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3"></div>

                </div>
                <div class="not-convinced clearfix">
                    <h5 class="text-center">NOT CONVINCED YET?</h5>
                    <h6 class="text-center">WALK IN AND GET ANSWERS TO ALL YOUR QUESTIONS?</h6>

                    <div class="col-xs-12 col-sm-12 col-md-2 col-md-offset-4 col-lg-offset-4 col-lg-2 text-center">
                        <a class="btn" onclick="window.location.assign('contact.php');">COCHIN</a>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 text-center">
                        <a class="btn" onclick="window.location.assign('contact.php');">PALAKKAD</a>
                    </div>
